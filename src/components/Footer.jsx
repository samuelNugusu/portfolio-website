...
Samuel — All rights reserved.</p>
        <div className="flex gap-4">
          <a className="hover:text-slate-200" href="https://github.com/samuelNugusu" target="_blank" rel="noreferrer">GitHub</a>
          <a className="hover:text-slate-200" href="https://www.linkedin.com/" target="_blank" rel="noreferrer">LinkedIn</a>
          <a className="hover:text-slate-200" href="mailto:samuelnugusu7@gmail.com">Email</a>
        </div>
      </div>
    </footer>
  )
